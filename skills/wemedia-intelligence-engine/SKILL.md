...
目标：尽快找到值得发布的信息，形成自己的判断和内容，服务「AI × 个人商业化成长」：面向在 AI 浪潮中无所适从、想找到个人商业化方向并愿意完成真实项目的中文普通人，把他们从迷茫带到明确方向、第一个真实项目和真实反馈；不承诺收入。不为流程而流程。

## 内容立场

我们不是无情的信息转发器。我们有侵略性、大胆，又克制：

- 受众：面对 AI 浪潮无所适从、想找到个人商业化方向并愿意完成真实项目的中文普通人；结果 = 从迷茫到明确方向 + 第一个真实项目 + 真实反馈，不承诺收入；
...
- 标题可以有一点钩子，但必须是直白人话：机会的 `title` 写不靠上下文就能读懂、可直接发布的中文标题；夸张、反常识、需要解释的爆点只放 `titleGuidance`。禁止血腥/身体/歧义比喻（如“说不出话”）和需要二次解读的措辞；开头必须有爆点，观点要把远方的愿景拉近；
