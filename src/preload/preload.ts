...
contextBridge.exposeInMainWorld('wmb', {
  ...
  confirmWebsiteSource: (input: unknown) => ipcRenderer.invoke('intelligence-channels:confirm-website', input),
  resolveXListCandidates: (input: { inputText: string }) => ipcRenderer.invoke('intelligence-channels:resolve-x-list', input),
  confirmResolvedXList: (input: unknown) => ipcRenderer.invoke('intelligence-channels:confirm-x-list', input),
  setIntelligenceChannelEnabled: (input: unknown) => ipcRenderer.invoke('intelligence-channels:set-enabled', input),
  removeIntelligenceChannel: (input: unknown) => ipcRenderer.invoke('intelligence-channels:remove', input),
