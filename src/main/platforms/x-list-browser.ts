...
async function switchMembersTab(session: XListSession, listId: string, tab: 'members' | 'suggested'): Promise<void> {
  if (tab === 'suggested') {
...
async function membersSheetReady(session: XListSession, tab: 'members' | 'suggested'): Promise<boolean> {
  if (tab === 'suggested') {
...
async function membersRoot(session: XListSession) {
...
async function addMemberInOpenSheet(session: XListSession, listId: string, handle: string, hooks: XListActionHooks): Promise<void> {
...
async function addMember(session: XListSession, listId: string, handle: string, hooks: XListActionHooks): Promise<void> {
  await openManagedMembers(session, listId, 'suggested');
  await addMemberInOpenSheet(session, listId, handle, hooks);
}

async function removeMember(session: XListSession, listId: string, handle: string, hooks: XListActionHooks): Promise<void> {
