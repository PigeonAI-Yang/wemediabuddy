export type ErrorCode = 'REVISION_CONFLICT' | 'INVALID_STATE' | 'ACCOUNT_MISMATCH' | 'CONFIRMATION_REQUIRED' | 'CONFIRMATION_STALE' | 'BROWSER_NEEDS_USER' | 'PUBLICATION_UNKNOWN' | 'METRIC_UNAVAILABLE' | 'NOT_FOUND' | 'VALIDATION_ERROR' | 'PI_RUNTIME_PROBE_FAILED';
